...
REM
REM Generated by Vivado on Thu Mar 19 20:40:30 -0400 2026
...
echo "xvlog --incr --relax -L uvm -prj softmax_unit_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj softmax_unit_tb_vlog.prj -log xvlog.log
